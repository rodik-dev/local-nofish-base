...
module.exports = {
    ...
    plugins: [
        plugin(function ({ addBase, theme }) {
            addBase({
                'h1': { fontSize: themeStyle.h1.size, lineHeight: themeStyle.h1.lineHeight + 'px', textDecoration: themeStyle.h1.textDecoration },
                'h2': { fontSize: themeStyle.h2.size, lineHeight: themeStyle.h2.lineHeight + 'px' },
            })
        })
    ]
};
